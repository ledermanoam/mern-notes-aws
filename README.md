...
React + Express notes app deployed on AWS: API on EC2, database on RDS Postgres, frontend on S3 (optionally CloudFront). Use `ARTICLE.md` for the full step-by-step deployment guide and Free Tier notes.
